...
allt_abun2 <- c("Sampling Location", "Cropping System", "Sampling Method", 
           "Landscape Complexity", "Taxonomic Category")
...
allt_dive2 <- c("Taxonomic Category", "Sampling Location", "Sampling Method",  "Cropping System",
