...
dat_abun$level <- c("All", "Bees", "Bumblebees", "Butterflies", "Hoverflies", "Solitary Bees", "Across System", "Center", "Edge", "Margin", "Cereal", "Mixed", "Perrenial", "Combination", "Pan Traps", "Transects", "Complex", "Gradient", "Simple")
...
dat_dive$level <- c("All", "Bees", "Bumblebees", "Butterflies", "Hoverflies", "Moths", "Solitary Bees", "Across System", "Center", "Edge", "Margin", "Cereal", "Mixed", "Pasture", "Perrenial", "Combination", "Other", "Pan Traps", "Transects", "Trap Nests", "Complex", "Gradient", "Simple")
...
forestplot <- ggplot() +
  ...
  scale_y_continuous(name = "", breaks=c(22:1), expand = c(0, 0),
                        labels=c( "Complex", "Gradient", "Simple",
                                  ...
                                  "Bees", "Bumblebees",  "Solitary Bees", "Butterflies", "Hoverflies", "Moths", 
                                  "Across System", "Center", "Edge", "Margin",   
                                  "Combination", "Pan Traps", "Transects", "Trap Nests", "Other"),
                        limits=c(0.5,24)) + 
  annotate("text", x = -3.3, y = 23.25, label = "Diversity", hjust=1, color=cols[2]) +  
  annotate("text", x = -3.3, y = 22.75, label = "Abundance", hjust=1, color=cols[6]) +  
  coord_cartesian(clip = "off", xlim=c(-2.6, 7)) +
...
png("Figures-2_Forestplot.png", width=5, height=7.5, units="in",res=300)
forestplot
dev.off()
